/** A single multiple-choice quiz question generated by the LLM. */
...
/**
 * Composable for AI-generated multiple-choice quizzes.
 *
 * Generates questions from class note embeddings using the on-device LLM,
 * with a deterministic fallback when the model output is malformed.
 */
